...
| **ExternalSubtitle**            | 单功能演示模块 | 字幕渲染组件在SDK内部高度集成，不再需要设置回调 | ExternalSubtitleViewController |
| **CustomStyleExternalSubtitle** | 单功能演示模块 | 外挂字幕高级样式定制,可配置字体种类样式等       | CustomStyleExternalSubtitleViewController |
