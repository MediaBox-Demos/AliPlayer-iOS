Pod::Spec.new do |s|
  s.name             = 'ExternalSubtitle'
  s.version          = '1.0.0'
  s.summary          = 'ExternalSubtitle functionality module'
  s.description      = 'ExternalSubtitle video playback functionality demonstration, core SDK showcase'
  ...
  # s.resource = 'Resources/ExternalSubtitle.bundle'
