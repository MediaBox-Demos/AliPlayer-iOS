...
Pod::Spec.new do |s|
  s.name             = 'App'
  s.version          = '1.0.0'
  s.summary          = 'Main App module for iOS API Example'
  ...
  s.description      = 'Main application module containing the home page and navigation structure'
...
#  s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  ...
  # s.resource = 'Resources/App.bundle'
