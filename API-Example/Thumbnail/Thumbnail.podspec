Pod::Spec.new do |s|
  s.name             = 'Thumbnail'
  s.version          = '1.0.0'
  s.summary          = 'Thumbnail functionality module'
  s.description      = 'Thumbnail video playback functionality demonstration, core SDK showcase'
  ...
  # s.resource = 'Resources/Thumbnail.bundle'
